...
logo = ''' \033[0;96m   ___    ___    ____   
 \033[0;96m  / _ |  / _ )  / __/ \x1b[1;93m® \033[0m| Created By RIAZKHAN
 \033[1;93m / __ | / _  | / _/     \033[0m| Github.com/Riazkiller
 \033[1;93m/_/ |_|/____/ /_/  \033[0;91mv2.0 \033[0m| Facebook.com/riazkhan
██████╗ ██╗ █████╗ ███████╗
██╔══██╗██║██╔══██╗╚══███╔╝
██████╔╝██║███████║  ███╔╝ 
██╔══██╗██║██╔══██║ ███╔╝  
...
def yayanxd():
    ...
    try:
        ...
        print '%s╠══[%s Subscribe Channel RIAZKHAN Dulu Ya:v \033[0;96m]'%(O,N);time.sleep(2)
...
def info_tools():
    ...
    print '%s[%s>%s] Author   : RIAZLHAN.'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Github   : https://github.com/Riazkiller'%(N,H,N);time.sleep(0.09)
    ...
    print '%s[%s>%s] • Aang RIAZKHAN'%(N,H,N);time.sleep(0.09)
